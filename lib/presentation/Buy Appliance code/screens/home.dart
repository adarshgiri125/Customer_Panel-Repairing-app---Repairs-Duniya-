// import 'package:customer_app/presentation/Buy%20Appliance%20code/screens/allProducts.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Future<List<ItemsModel>> fetchItems() async {
    ...
    return snapshot.docs
        ...
        .where((item) =>
            item.available) // Filter the items where available is true
        .toList();
  }
              ...
              FutureBuilder<List<ItemsModel>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    // Ensure there are at least 5 items available
