...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> literOptions = [
      {'text': '6 liters', 'available': true},
      {'text': '10 liters', 'available': true},
      {'text': '25 liters', 'available': true},
    ];
                    ...
                    children: [
                      ...
                      Consumer<CartProvider>(
                        builder: (context, cartProvider, child) {
                          return Row(
                            children: literOptions.map((option) {
                              return GestureDetector(
                                onTap: () {
                                  if (option['available']) {
                                    cartProvider
                                        .selectLiterOption(option['text']);
                                  }
                                },
                                child: OptionBox(
                                  text: option['text'],
                                  ...
                                  isSelected:
                                      cartProvider.selectedLiterOption ==
                                          option['text'],
                                ),
                              );
                            }).toList(),
